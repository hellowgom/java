...
public class Example1 {
    public static void main(String[] args) {
       ...
       // char형은 문자 하나만 저장하고 단따옴표를 사용한다.
        ...
        System.out.println(ch1 + ch2); // 131 (대문자A는 65, 대문자B는 66)
        ...
        String name = "Steve"; // 문자열은 String으로 생성한다. // Steve는 10byte(2byte*5)
        System.out.println(name); // Steve
        System.out.println(name.length()); // 5
        String str1 = "한글"; // 한글은 4byte(2byte*2)
        System.out.println(str1.length()); // 2

        boolean bool = true; // ture는 참을 의미하는 예약어(키워드), 숫자로는 1
