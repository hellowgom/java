...
public class TypeChange3 {
    public static void main(String[] args) {
        ...
        byte data1 = 3;
        byte data2 = 5;
        // byte value5 = data1 + data2; // 에러발생. int + int 이므로 byte에 저장불가
        ...
        // 굳이 int에 담고자다면,
        int value7 = 3 + (int)3.5; // 6  int + int
        System.out.println(value7);

        double value = 5 / 2.0; // 2.5  double / double
        byte data3 = 3;
        short data4 = 5;
        int value9 = data3 + data4; // int + int 이므로 int(기본 자료형)에 담을 수 있다.
