...
public class ShiftOperator {
    public static void main(String[] args) {
        ...
        // 곱셈과 나눗셈이 계산을 매우 빠르게 할 수 있음.

        System.out.println(5 >> 1); // 2          5/2 = 정확한 계산 불가능!
        System.out.println(-5 >> 1); // -3        -5/2 = 정확한 계산 불가능!
        // 오른쪽 시프트의 경우에는 오른쪽 비트값이 삭제되므로 정확한 계산 불가능!
        // 정밀한 나누기 계산이 필요한 곳에는 시프트연산대신 나누기를 사용해야함!

        System.out.println(Integer. toBinaryString(-3)); // 11111111 11111111 11111111 11111101 = -3
        ...
        mask = 1 << 2; // 2번째 위치 확인
        System.out.println(value & mask);  // 0 (해당 위치가 0 이라는 뜻)
